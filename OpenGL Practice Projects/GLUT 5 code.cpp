...
void display()
{
    ...
    glTranslatef(0,0,x_position);
     ...
     glColor3f(1,0,0);
    glVertex3f(-1.0,1.0,0);//specifies the x, y & z coordinates of the vertex
    glColor3f(1,1,0);
    ...
    if (x_position<-5 && direction==true)
        x_position=x_position+0.15;
    else if (-15<=x_position)
    {
        x_position=x_position-0.15;
        direction=false;
    }
...
void reshape(int w, int h)
{
    ...
    gluPerspective(60,1,2,50);//set up a perspective projection matrix
